...
CREATE TABLE "HistoryJenis" (
    ...
    CONSTRAINT "HistoryJenis_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Transaksi" ADD CONSTRAINT "Transaksi_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Transaksi" ADD CONSTRAINT "Transaksi_idjenissampah_fkey" FOREIGN KEY ("idjenissampah") REFERENCES "JenisSampah"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
